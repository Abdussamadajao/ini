...
const useDateRangePickerStyles = makeStyles(
  ({ colors, radius, typography }) => ({
    ...
    selectError: { borderColor: colors.status.error.main, borderWidth: 1 },
    ...
    headerSide: { width: 56, flexDirection: "row", alignItems: "center" },
    ...
    activeRangeArrow: { paddingHorizontal: 4 },
    monthRow: {
      flexDirection: "row",
      alignItems: "center",
      justifyContent: "space-between",
    ...
    calendarGrid: { backgroundColor: "transparent" },
    dayCell: {
      width: "14.28%",
      aspectRatio: 1,
      alignItems: "center",
    ...
    dayTextOther: { color: colors.text.secondary, opacity: 0.45 },
    dayTextInRange: { color: colors.text.primary },
    dayTextSelected: { color: colors.primary.contrastText },
    applyRangeSection: { paddingHorizontal: 16, paddingTop: 28, marginTop: 8 },
    applyRangeBtn: {
      flexDirection: "row",
      alignItems: "center",
      justifyContent: "center",
